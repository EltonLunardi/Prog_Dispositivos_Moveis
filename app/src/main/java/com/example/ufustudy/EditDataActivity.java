...
public class EditDataActivity extends Activity {
    ...
    EditText name, sobrenome, N_Matricula, SubJect;
    ...
    String GetName, GetSobrenome, GetN_Matricula, GetSubject;
    int UserID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sobrenome = (EditText) findViewById(R.id.editText4);
        N_Matricula = (EditText) findViewById(R.id.editText2);
        SubJect = (EditText) findViewById(R.id.editText3);

        idtextview = (TextView) findViewById(R.id.textview1);

        GetSQliteQuery = "SELECT * FROM Aluno";
        ...
        updatebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                GetSobrenome = sobrenome.getText().toString();
                GetN_Matricula = N_Matricula.getText().toString();
                ...
                UpdateRecordQuery = "UPDATE Aluno SET name='" + GetName + "', sobrenome='" + GetSobrenome + "', N_Matricula='" + GetN_Matricula + "', subject='" + GetSubject + "' WHERE ID=" + UserID + ";";

                CheckEditTextIsEmptyOrNot(GetName, GetSobrenome, GetN_Matricula, GetSubject);
        ...
        deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ConvertUserID = idtextview.getText().toString();
                UserID = Integer.parseInt(ConvertUserID);
                DeleteQuery = "DELETE FROM Aluno WHERE id=" + UserID + ";";
    ...
    public void GetSQLiteDatabaseRecords() {
        ...
        sobrenome.setText(cursor.getString(2));
        N_Matricula.setText(cursor.getString(3).toString());
        SubJect.setText(cursor.getString(4).toString());
    }
